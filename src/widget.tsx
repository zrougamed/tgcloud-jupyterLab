...
const CloudListingComponent = (): JSX.Element => {
  ...
  useEffect(() => {
      ...
      let rows = listMachines["Result"].map(function(d) { 
        ...
        {
        return (<tr>
        <td> <img src={d.Logo} style={{width:"20px",height:"20px"}} /> <input type="hidden" id="machineID" value={d.ID} /> <input type="hidden" id="machineDomain" value={d.Domain} /></td>
        <td>{d.Name}</td>
        <td>{d.Tag}</td>
        <td><i className={"fa fa-circle "+ d.State} aria-hidden="true"> </i> {d.State} </td>
        <td>{d.ExternalInstanceType}</td>
        <td>{d.CreatedAt}</td>
        <td>{d.UpdatedAt}</td>
        <td className="actions">
          <i className="fa fa-play" style={{color: "grey",padding:"10px"}}  aria-hidden="true"></i>
          <i className="fa fa-stop" style={{color: "grey",padding:"10px"}} aria-hidden="true"></i>
          <i className="fa fa-tasks" style={{color: "grey",padding:"10px"}} aria-hidden="true"></i>
        </td>
        </tr>)
        }
        if (d.State == "stopped")
        ...
        <td>{d.UpdatedAt}</td>
        <td className="actions">
          <a href="#" onClick={() => opsMachines("start",d.ID)}><i className="fa fa-play" style={{padding:"10px"}} aria-hidden="true"></i></a>
          <i className="fa fa-stop" style={{color: "grey",padding:"10px"}} aria-hidden="true"></i>
          <i className="fa fa-tasks" style={{color: "grey",padding:"10px"}} aria-hidden="true"></i>
        </td>
        </tr>)
        ...
        <td className="actions">
          <i className="fa fa-play" style={{color: "grey",padding:"10px"}} aria-hidden="true"></i>
          <a href="#" onClick={() => opsMachines("stop",d.ID)}><i className="fa fa-stop" style={{padding:"10px"}}  aria-hidden="true"></i></a>
          <a href="#" onClick={() => loaderAlgo(d.Domain,d.ID)}><i className="fa fa-tasks" style={{padding:"10px"}}  aria-hidden="true"></i></a>
        </td>
        </tr>)
        }
...
<div className="logout"> 
  ...
  <ul className="nav nav-tabs" role="tablist">
    <li role="presentation" className="active">
      <a href="#" aria-controls="tab1" onClick={() => backtoListing()}  role="tab" data-toggle="tab">Machines</a>
    </li>
    <li role="presentation" >
      <a href="#" aria-controls="tab2" role="tab" data-toggle="tab">Algo Loader</a>
    </li>
  </ul>
  ...
  <div id="tabs-content" className="tab-content panel-group">
    <div className="panel-heading" role="tab" id="heading1">
      <a href="#tab1"  role="button" data-toggle="collapse" data-parent="tabs-content" aria-expanded="true" aria-controls="tab1">Tab 1</a>
    </div>
    <div id="tab1" role="tabpanel" className="tab-pane active panel-collapse collapse in active" aria-labelledby="heading1">
      <h4>My solutions <i className="fa fa-compass" aria-hidden="true" /></h4>
      <table className="table">
        <thead>
          <tr>
            ...
            <th scope="col">Actions <i className="fa fa-cog" aria-hidden="true" /></th>
          </tr>
        </thead>
        <tbody id="rows">
    ...
    <div className="panel-heading" role="tab" id="heading2">
      <a href="#tab2" className="collapsed" role="button" data-toggle="collapse" data-parent="tabs-content" aria-expanded="true" aria-controls="tab2">Tab 2</a>
    </div>
...
const CounterComponent = (): JSX.Element => {
  ...
  return (
    <div id="root" style={rootContainer}>
      <div id="Loader" className="Loader"><div className="spinner"></div></div>
    <div className="container">
      ...
      <div className="container-mini">
        ...
        <form style={boxlogin} noValidate autoComplete="off">
                  <img width="50%" src="https://tgcloud.io/assets/img/tgcloud-logo.png"></img>
                  <h3 >TigerGraph Cloud</h3>
                  <br></br>
                  <div className="form-group">
                      <input  id="username" type="email"  className="texts" placeholder="Enter email" onChange={handleUsernameChange}
              onKeyPress={handleKeyPress} />
                  </div>
                  <div className="form-group">
  
                      <input  id="password" type="password"  className="texts" placeholder="Enter password" onChange={handlePasswordChange}
              onKeyPress={handleKeyPress}  />
                  </div>

                  <br></br>
                  <div style={mystyle} className="btn btn-primary btn-block">
                   <button  style={mystyleButton} type="button" onClick={handleLogin}  disabled={state.isButtonDisabled}> 
                     Sign in
                    </button>
                  </div>
