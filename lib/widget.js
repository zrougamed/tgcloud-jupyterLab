...
const LogOut = () => {
    ...
    ReactDOM.render(React.createElement(CounterComponent, null), rootElement);
};
// load the function
    ...
    return (React.createElement("div", { id: "listing", className: "listingStyle" },
        ...
        React.createElement("div", { className: "responsive-tabs" },
            ...
            React.createElement("ul", { className: "nav nav-tabs", role: "tablist" },
                React.createElement("li", { role: "presentation", id: "ListingTabIndic", className: "active" },
                    React.createElement("a", { href: "#", "aria-controls": "tab1", onClick: () => backtoListing(), role: "tab", "data-toggle": "tab" }, "Machines")),
                React.createElement("li", { id: "AlgoTabIndic", role: "presentation" },
